...
static CV_PossibleValue_t backcolor_cons_t[] = {{0, "White"}, 	{1, "Gray"},	{2, "Brown"},
												...
												{9,	"Dark_blue"}, {10,"Gold"},  {11,"Rust"},
												{12,"Purple"},  {13,"Lavender"}, {14,"Pink"},
												{15,"Steel_blue"}, {16,"Teal"}, {17,"Zim"},
												{18,"Peach"}, {19,"Hot_Pink"}, {20,"Sky_Blue"},
												{21,"Grass"},
												{0, NULL}};
...
void CON_SetupBackColormap(void)
{
	...
	switch (cons_backcolor.value)
	{
		...
		case 5:		palindex = 111;	shift = 7; break; // Yellow
		case 6:		palindex = 175;	break; // Green
		case 7:		palindex = 239;	break; // Blue
		case 8:		palindex = 219;	break; // Cyan
		// New colours added
		case 9: 	palindex = 243; break; // Dark Blue
		case 10:	palindex = 119; shift = 7; break; // Gold
		case 11:	palindex = 159; break; // Rust
		case 12:	palindex = 199; shift = 7; break; // Purple
		case 13:	palindex = 254; shift = 7; break; // Lavender
		case 14: 	palindex = 151; shift = 7; break; // Pink
		case 15: 	palindex = 207; shift = 7; break; // Steel Blue
		case 16: 	palindex = 223; shift = 8; break; // Teal
		case 17: 	palindex = 183; shift = 7; break; // Zim
		case 18: 	palindex = 79; shift = 7; break; // Peach
		case 19: 	palindex = 126; shift = 7; break; // Hot Pink
		case 20: 	palindex = 228; shift = 8; break; // Sky Blue
		case 21: 	palindex = 168; shift = 7; break; // Grass
		// Default green
...
static void CON_SetupColormaps(void)
{
	...
	cyanmap	  = (UINT8 *)Z_Malloc(256, PU_STATIC, NULL);
	debluemap = (UINT8 *)Z_Malloc(256, PU_STATIC, NULL);
	zimmap 	  = (UINT8 *)Z_Malloc(256, PU_STATIC, NULL);
	hinkmap	  = (UINT8 *)Z_Malloc(256, PU_STATIC, NULL);
	azuremap  = (UINT8 *)Z_Malloc(256, PU_STATIC, NULL);
	...
	cyanmap[3] 	 = (UINT8)212;
	cyanmap[9] 	 = (UINT8)215;
	debluemap[3] = (UINT8)237;
	debluemap[9] = (UINT8)243;
	zimmap[3] 	 = (UINT8)178;
	zimmap[9]	 = (UINT8)183;
	hinkmap[3] 	 = (UINT8)148;
	hinkmap[9]	 = (UINT8)151;
	azuremap[3]	 = (UINT8)202;
	azuremap[9]	 = (UINT8)205;
	tealmap[3] 	 = (UINT8)247;
	tealmap[9]	 = (UINT8)223;
