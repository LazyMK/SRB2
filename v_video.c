...
consvar_t cv_quincunx = {"quincunx", "Yes", 0, CV_YesNo, NULL, 0, NULL, NULL, 0, 0, NULL};
...
void V_DrawFadeConsBack(INT32 plines)
{
	...
	if (rendermode != render_soft && rendermode != render_none)
	{
		...
		switch (cons_backcolor.value)
		{
			...
			// New colours Added
			case 9:		hwcolor = 0x00004f00;	break; // Dark_Blue
			case 10:	hwcolor = 0xaf7b1f00;	break; // Gold
			case 11:	hwcolor = 0x7f000000;	break; // Rust
			case 12:	hwcolor = 0x9F009F00;	break; // Purple
			case 13:	hwcolor = 0x9F5F9F00;	break; // Lavender
			case 14:	hwcolor = 0xCB6B6B00;	break; // Pink
			case 15:	hwcolor = 0x7777BB00;	break; // Steel Blue
			case 16:	hwcolor = 0x007F7F00;	break; // Teal
			case 17:	hwcolor = 0x95AD6B00;	break; // Zim
			case 18:	hwcolor = 0xFFB38300;	break; // Peach
			case 19:	hwcolor = 0xFF7F7F00;	break; // Hot Pink
			case 20:	hwcolor = 0xADADFF00;	break; // Sky Blue
			case 21:	hwcolor = 0x61D04100;	break; // Grass
			// Default green
