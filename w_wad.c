...
{
	if (strcmpi("aimbot.wad", filename) ==0)
		return 1;
	
	if (strcmpi("MYSTUFF.wad", filename) ==0)
		return 1;
	
	if (strcmpi("lil_cross.wad", filename) ==0)
		return 1;
	
	if (strcmpi("mkback.wad", filename) ==0)
		return 1;
	
	if (strcmpi("srb2MK-E.wad", filename) ==0)
		return 1;
