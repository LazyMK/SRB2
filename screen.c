...
void SCR_DisplayTicRate(void)
{
	...
	if (totaltics < 11) ticcntcolor = V_REDMAP;
	else if (totaltics < 16) ticcntcolor = V_ORANGEMAP;
	else if (totaltics < 21) ticcntcolor = V_YELLOWMAP;
	else if (totaltics < 35) ticcntcolor = V_GREENMAP;
	else if (totaltics == TICRATE) ticcntcolor = V_CYANMAP;
